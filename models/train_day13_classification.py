...
day13_mean_and_var = pandas.read_csv('day13_mean_and_var.txt', sep = '\t', header = 0)

initial_train_set = OrganoidDataset(path2files = path, well_labels = well_labels, day_label_X = day_label_X, Y = nonEmptyWellIndicator, intensity_mean = day13_mean_and_var['mean'][0], intensity_var = day13_mean_and_var['variance'][0])
